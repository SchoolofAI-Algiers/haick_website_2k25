...
export default function FAQ() {
  ...
  const faqs = [
    {
      ...
      answer: "Haick25 is a global event focused on AI and data science, bringing together enthusiasts to collaborate and innovate.",
    },
    {
      question: "What is Haick25 about?",
      answer: "This is a test answer for the second question. It will slide down smoothly when you click the question.",
    },
    {
      question: "What is Haick25 about?",
      answer: "Haick24 is the third edition of Haick, a datathon designed for all AI and data science enthusiasts.",
    },
    {
      question: "What is Haick25 about?",
      answer: "Another test answer to demonstrate the sliding animation and icon rotation.",
    },
    {
      question: "What is Haick25 about?",
      answer: "Final test answer for the FAQ section to ensure everything works as expected.",
    },
  ];
  ...
  return (
    <div
      className="w-full py-12 bg-gray-100 relative overflow-hidden"
      style={{
        backgroundImage:
