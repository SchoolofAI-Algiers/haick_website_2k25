...
const About = () => {
	...
	return (
		<div className="text-center py-10 px-5">
			...
			<div className="mx-auto w-[90%] max-w-[1000px] bg-[#ECEEED] border-3 border-[#F7A209] overflow-hidden shadow-md">
					...
					<div className="flex-1 w-full md:w-1/2 p-6 text-start text-sm text-gray-800 border-b-3 md:border-b-0 md:border-r-3 border-[#F7A209]">
						...
						<p className="font-light leading-relaxed">
							**School of AI Algiers** is a scientific club established in 2018
							...
							The club unites young, motivated AI enthusiasts to help them
							unlock their potential and enhance their skills in the field of
							artificial intelligence. To achieve this, the club organizes **a
							range of events,** including Haick, a datathon where participants
							address AI and data science challenges. Additionally, the club
							hosts international conferences such as **AiSummit and Indaba**,
