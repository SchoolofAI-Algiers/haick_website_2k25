...
export default function AgendaComponent() {
  ...
  const spacingMultiplier = windowWidth < 640 ? 0.5 : windowWidth < 1024 ? 1 : 1.5;
  ...
  const buttonPosition = windowWidth < 640 ? "10px" : windowWidth < 1024 ? "15%" : "25%";
    ...
    >
      <div className="bg-white h-full p-8 flex flex-col ">
        <div className="text-center mb-6">
          <h2 className="text-3xl font-bold mt-[20%]  text-gray-700">Day {day.number}</h2>
